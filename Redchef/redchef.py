  ...
  #      p.sendline("nmap 192.168.56.101")
   ...
   #     print(s1) 
      #  import nmap3
        ...
        results = nmap.nmap_portscan_only("192.168.56.101")
	#print(results['192.168.56.101']['ports'])
        x = results['192.168.56.101']['ports']
...
#                        won=True, lost=True)
    ...
    def act(self, obs: str, score: int, done: bool, actions: Mapping[str, Any]) -> Optional[str]:
      ...
      #  print(score)
       # f = open('ledeepexploitkaireward2.txt', 'a', encoding='UTF-8') 
       # f.write(str(score)+'\n')
     #   f.close()
      #  print(len(actions))
     ...
     #   print(input_)
        ...
        commands_tensor = self._process(actions)
